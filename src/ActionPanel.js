        ...
        return (
            <div
                ...
                <AriaDisablingButton
                    ...
                    className='ActionPanel__action-buttons focus-trap-action-buttons'
                ...
                <AriaDisablingButton
                    ...
                    className='ActionPanel__action-buttons focus-trap-action-buttons focus-trap-replace-action-button'
